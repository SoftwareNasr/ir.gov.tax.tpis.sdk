...
class TspWithTaxpayerKeyTest {
    ...
    public static void main(String[] args) throws URISyntaxException, IOException {
        TspWithTaxpayerKeyTest test = new TspWithTaxpayerKeyTest();
        test.setUp();
    ...
    void setUp() throws URISyntaxException, IOException {
        ...
        this.transferApi = new ObjectTransferApiImpl(apiConfig);
    ...
    void sendInvoices() throws URISyntaxException, IOException {
        ...
        AsyncResponseModel responseModel = transferApi.sendPackets(Collections.singletonList(packetDto), headers, true, false);
