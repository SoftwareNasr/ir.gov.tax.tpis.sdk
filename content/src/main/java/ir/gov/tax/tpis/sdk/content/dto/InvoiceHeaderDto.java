...
public class InvoiceHeaderDto {
     ...
     * مجموع وزن خالص
     */
    public BigDecimal tonw;

    /**
     * مجموع ارزش ریالی
     */
    public BigDecimal torv;

    /**
     * مجموع ارزش ارزی
     */
    public BigDecimal tocv;
    ...
    public String getScln() {
        return scln;
    }

    public void setScln(String scln) {
        this.scln = scln;
    }
    ...
    public Integer getCdcd() {
        return cdcd;
    }

    public void setCdcd(Integer cdcd) {
        this.cdcd = cdcd;
    }

    public BigDecimal getTonw() {
        return tonw;
    }

    public void setTonw(BigDecimal tonw) {
        this.tonw = tonw;
    }

    public BigDecimal getTorv() {
        return torv;
    }

    public void setTorv(BigDecimal torv) {
        this.torv = torv;
    }

    public BigDecimal getTocv() {
        return tocv;
    }

    public void setTocv(BigDecimal tocv) {
        this.tocv = tocv;
    }
}
