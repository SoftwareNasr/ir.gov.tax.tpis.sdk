...
public class ObjectTransferApiImpl implements TransferApi {
    ...
    public AsyncResponseModel sendPackets(List<PacketDto> packets,
        ...
        request.setSignature(config.getTransferSignatory().sign(normalizedJson));
        if (config.getTransferSignatory().getKeyId() != null) {
            request.setSignatureKeyId(config.getTransferSignatory().getKeyId());
        }
    ...
    public SyncResponseModel sendPacket(PacketDto packet,
        ...
        if (packet.getSignatureKeyId() != null) {
            ...
            normalizedJson = config.getNormalizer().normalize(new ObjectTransferApiImpl.PacketDtoWithoutSignatureKeyId(packet), headers);
        }
